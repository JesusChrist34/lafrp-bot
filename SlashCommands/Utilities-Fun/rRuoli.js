...
module.exports = {
    name: 'rimozione-ruoli',
    description: 'Inoltra una richiesta allo staff per la rimozione di uno o più ruoli',
    timeout: 5000,
    premium: false,
    options: [
      {
        name: 'ruolo_1',
        description: 'Il primo ruolo da voler rimuovere',
        type: 'ROLE',
        required: true,
      },
      {
        name: 'ruolo_2',
        description: 'Il secondo ruolo da voler rimuovere',
        type: 'ROLE',
        required: false,
      },
      {
        name: 'ruolo_3',
        description: 'Il terzo ruolo da voler rimuovere',
        type: 'ROLE',
        required: false,
      },
      {
        name: 'ruolo_4',
        description: 'Il quarto ruolo da voler rimuovere',
        type: 'ROLE',
        required: false,
      },
    ],
    ...
    .setTitle("**__Richiesta Rimozione Ruoli__**")
    ...
    .setTitle("**__Richiesta Rimozione Ruoli__**")
    .setDescription(`
**E' stata appena inviata una nuova richiesta di rimozione ruoli.
